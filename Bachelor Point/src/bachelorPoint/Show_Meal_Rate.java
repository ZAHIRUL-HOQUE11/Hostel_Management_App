 ...
 * @author zahirul
 */
public class Show_Meal_Rate extends javax.swing.JFrame implements MenuListener, MouseListener, ActionListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Meal_Rate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_Meal_Rate().setVisible(true);
            }
        });
    }
