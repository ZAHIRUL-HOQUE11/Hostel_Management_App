...
public class Add_Cost extends javax.swing.JFrame implements MenuListener, MouseListener, ActionListener {
    ...
    private void initComponents() {
        ...
        addButnCost = new javax.swing.JButton();
        clearButnCost = new javax.swing.JButton();
        jLabel10 = new javax.swing.JLabel();
        AddDepDate = new javax.swing.JTextField();
        ...
        addButnCost.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        addButnCost.setForeground(new java.awt.Color(102, 0, 102));
        addButnCost.setText("Add");
        addButnCost.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        addButnCost.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addButnCostActionPerformed(evt);
            }
        });

        clearButnCost.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        clearButnCost.setForeground(new java.awt.Color(102, 0, 102));
        clearButnCost.setText("Clear");
        clearButnCost.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        clearButnCost.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                clearButnCostActionPerformed(evt);
            }
        });
        ...
        AddDepDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddDepDateActionPerformed(evt);
            }
        });
        AddDepDate.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AddDepDateKeyPressed(evt);
            }
        });
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(AddDepMemName, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(AddDepMemRomN, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(AddDepMemSitN, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(AddDepDate, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel6)
                            .addComponent(AddDepMemTK, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(clearButnCost)
                        .addGap(29, 29, 29)
                        .addComponent(addButnCost)))
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(AddDepDate, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(jLabel6)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void AddDepDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddDepDateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AddDepDateActionPerformed

    private void clearButnCostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearButnCostActionPerformed

        clearText();
    }//GEN-LAST:event_clearButnCostActionPerformed

    private void addButnCostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButnCostActionPerformed

        try {
            String userName = LoginFrame.getUserName();
            String userPass = LoginFrame.getUserPass();
            String memName = AddDepMemName.getText();
            String roomNo = AddDepMemRomN.getText();
            String sitNo = AddDepMemSitN.getText();
            String date = AddDepDate.getText();
            String taka = AddDepMemTK.getText();
            newCost = Integer.parseInt(AddDepMemTK.getText());
            int userCost = newCost + Show_Cost_Chart.getTotalCost();
            Show_Cost_Chart.setTotalCost(userCost);

            String sql = "insert into add_cost_chart values('" + userName + "','" + userPass + "','" + memName + "','" + roomNo + "','" + sitNo + "','" + date + "','" + taka + "');";
            ConnectionJDB cont = new ConnectionJDB();
            cont.createConnection();
            cont.dataInsert(sql);
            cont.con.close();
            JOptionPane.showMessageDialog(rootPane, "Add Cost Successful");
            clearText();
        } catch (SQLException ex) {
            System.out.println(ex);
        }

    }//GEN-LAST:event_addButnCostActionPerformed
    ...
    private void AddDepMemNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AddDepMemNameKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_AddDepMemNameKeyTyped
    ...
    private void AddDepMemSitNKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AddDepMemSitNKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (AddDepMemSitN.getText().isEmpty()) {
                ...
                AddDepDate.requestFocus();
            }
        }

    }//GEN-LAST:event_AddDepMemSitNKeyPressed

    private void AddDepDateKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AddDepDateKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (AddDepDate.getText().isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Date is empty!!");
            } else {
                AddDepMemTK.requestFocus();
            }
        }

    }//GEN-LAST:event_AddDepDateKeyPressed
    ...
    private javax.swing.JTextField AddDepDate;
    ...
    private javax.swing.JButton addButnCost;
    private javax.swing.JButton clearButnCost;
