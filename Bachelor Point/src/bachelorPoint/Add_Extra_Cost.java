 ...
 * @author zahirul
 */
public class Add_Extra_Cost extends javax.swing.JFrame implements MenuListener, MouseListener, ActionListener {
    ...
    private void initComponents() {
        ...
        dateExtra = new javax.swing.JTextField();
        costExtra = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        commentExtra = new javax.swing.JTextArea();
        addButnextra = new javax.swing.JButton();
        clearButnExtra = new javax.swing.JButton();
        ...
        dateExtra.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                dateExtraKeyPressed(evt);
            }
        });

        costExtra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                costExtraActionPerformed(evt);
            }
        });
        costExtra.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                costExtraKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                costExtraKeyTyped(evt);
            }
        });

        commentExtra.setColumns(20);
        commentExtra.setRows(5);
        commentExtra.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                commentExtraKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(commentExtra);

        addButnextra.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        addButnextra.setForeground(new java.awt.Color(102, 0, 102));
        addButnextra.setText("Add");
        addButnextra.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        addButnextra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addButnextraActionPerformed(evt);
            }
        });

        clearButnExtra.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        clearButnExtra.setForeground(new java.awt.Color(102, 0, 102));
        clearButnExtra.setText("Clear");
        clearButnExtra.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        clearButnExtra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                clearButnExtraActionPerformed(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("Tahoma", 3, 20)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 51, 51));
        jLabel6.setText("Add Extra Cost ");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(clearButnExtra)
                        .addGap(31, 31, 31)
                        .addComponent(addButnextra)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel1)
                            .addComponent(dateExtra, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(41, 41, 41)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(costExtra, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(costExtra, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(dateExtra, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(136, 200, Short.MAX_VALUE))
    ...
    private void costExtraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_costExtraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_costExtraActionPerformed
    ...
    private void clearButnExtraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearButnExtraActionPerformed

        clearText();

    }//GEN-LAST:event_clearButnExtraActionPerformed

    private void addButnextraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButnextraActionPerformed

        try {
            String userName = LoginFrame.getUserName();
            String userPass = LoginFrame.getUserPass();
            String date = dateExtra.getText();
            String taka = costExtra.getText();
            String comment = commentExtra.getText();
            int newCost =Integer.parseInt(taka);
            int userECost = Show_Extra_Cost_Chart.getExtraCost()+newCost;
            Show_Extra_Cost_Chart.setExtraCost(userECost);

            String sql = "insert into add_extra_cost_chart values('" + userName + "','" + userPass + "','" + date + "','" + taka + "','" + comment + "');";
            ConnectionJDB cont = new ConnectionJDB();
            cont.createConnection();
            cont.dataInsert(sql);
            cont.con.close();
            JOptionPane.showMessageDialog(rootPane, "Extra Cost Add Successful");
            clearText();
        } catch (SQLException ex) {
            System.out.println(ex);
        }

    }//GEN-LAST:event_addButnextraActionPerformed

    private void costExtraKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_costExtraKeyTyped
    ...
    }//GEN-LAST:event_costExtraKeyTyped

    private void dateExtraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dateExtraKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (dateExtra.getText().isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Date box is empty!!");
            } else {
                costExtra.requestFocus();
            }
        }
        
    }//GEN-LAST:event_dateExtraKeyPressed

    private void costExtraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_costExtraKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (costExtra.getText().isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Cost is empty!!");
            } else {
                commentExtra.requestFocus();
            }
        }
        
    }//GEN-LAST:event_costExtraKeyPressed

    private void commentExtraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_commentExtraKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (commentExtra.getText().isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Comment box is empty!!");
            } else {
                addButnextra.requestFocus();
            }
        }
        
    }//GEN-LAST:event_commentExtraKeyPressed

    void clearText() {
        dateExtra.setText("");
        costExtra.setText("");
        commentExtra.setText("");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Extra_Cost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Extra_Cost().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton addButnextra;
    private javax.swing.JButton clearButnExtra;
    private javax.swing.JTextArea commentExtra;
    private javax.swing.JTextField costExtra;
    private javax.swing.JTextField dateExtra;
