 ...
 * @author zahirul
 */
public class About_User extends javax.swing.JFrame implements MenuListener, MouseListener, ActionListener {
    ...
    public About_User() {
       ...
       dECost = new JMenuItem("Delete Extra Cost");
        ...
        //For take user information
        String sql = "Select Mobile_Number,Month From user_information Where Name=? And Password=?;";

        String name = LoginFrame.getUserName();
        String pass = LoginFrame.getUserPass();
        String mob = null, month = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(About_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new About_User().setVisible(true);
            }
        });
    }
