 ...
 * @author zahirul
 */
public class About_Designer extends javax.swing.JFrame implements MenuListener, MouseListener, ActionListener {
    ...
    public About_Designer() {
        ...
        //For add designer image
        icon = new ImageIcon("src/bachelorPoint/designerImage.jpg");
        Image inputImage = icon.getImage();
        icon = new ImageIcon(resizeDesignerImage(inputImage, jLabel12.getWidth(), jLabel12.getHeight()));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Zahirul Hoque");

        jLabel9.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 51, 51));
        jLabel9.setText("01815009474");

        jLabel10.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(51, 51, 51));
        jLabel10.setText("zahirul.hoque1996@gmail.com");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 51, 153));
        jLabel11.setText("About Designer ");
    ...
    static Image resizeDesignerImage(Image img, int w, int h) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(About_Designer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new About_Designer().setVisible(true);
            }
        });
    }
